...
def make_measurer(run_timeout, repeat, number, enable_cpu_cache_flush,
    ...
    # runner = auto_scheduler.measure.RPCRunner(
    #     key="tx2", host="10.201.1.144", port=9090, timeout=run_timeout,
    #     repeat=repeat, number=number, enable_cpu_cache_flush=enable_cpu_cache_flush
    # )
